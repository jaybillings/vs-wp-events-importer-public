<?php
/**
 * Class VSEI_Loader - Register all actions and filters for the plugin.
 *
 * Maintain a list of all hooks that are registered throughout the plugin & register them
 * with the WP API. Call the `run` function to execute the lists of actions and filters.
 *
